...
var $author$project$Gen$Model$Counter = F2(
	function (a, b) {
		return {$: 'Counter', a: a, b: b};
	});
var $author$project$Gen$Msg$Counter = function (a) {
	return {$: 'Counter', a: a};
};
...
var $author$project$UI$face = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('/images/face.png'),
...
var $author$project$UI$icons = $author$project$Components$Material$row(
	_List_fromArray(
		[
			A2($author$project$Components$Material$column, 1, _List_Nil),
			A2(
			$author$project$Components$Material$column,
			2,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://github.com/opfer-10155')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('small fa-brands fa-github')
								]),
							_List_Nil)
						]))
				])),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('https://opfer-10155.hatenablog.com/')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('small fa-solid fa-blog')
								]),
							_List_Nil)
						]))
				]))
...
var $author$project$UI$sidebar = A2(
	$elm$html$Html$ul,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('sidenav sidenav-fixed')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('user-view')
						]),
					_List_fromArray(
						[
							A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Styles$Attr$flowText,
							$elm$html$Html$Attributes$align('center')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Syouki Tsuyama')
						]))
				])),
			A2(
			$elm$html$Html$li,
			...
			_List_fromArray(
				[
					A2($author$project$UI$viewLink, 'About me', $author$project$Gen$Route$Home_)
				])),
			A2(
			$elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					A2($author$project$UI$viewLink, 'Contact', $author$project$Gen$Route$Contact)
				])),
			A2(
			$elm$html$Html$li,
			_List_Nil,
		...
		[
			...
			_List_fromArray(
				[
					...
					3,
					_List_fromArray(
						[$author$project$UI$sidebar])),
					A2($author$project$Components$Material$column, 9, children)
				]))
		]);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Stateful Page Sample : Counter')
								])),
							A2(
							$elm$html$Html$div,
							_List_Nil,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Pages$Counter$Inc)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('+')
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Pages$Counter$Dec)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('-')
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('2018/4 ~ 2022/3')
								])),
							A2(
							$elm$html$Html$td,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('東京工業大学 情報理工学院 数理・計算科学系')
								]))
						])),
					A2(
					$elm$html$Html$tr,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('2022/4 ~ 2024/3(卒業予定)')
								])),
							A2(
							$elm$html$Html$td,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('東京工業大学 情報理工学院 数理・計算科学系 数理・計算科学コース')
								]))
						]))
				]))
		]));
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('2018/10 ~ 2020/7')
								])),
							A2(
							$elm$html$Html$td,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('アルバイト(プログラマ)')
								])),
							A2(
							$elm$html$Html$td,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('エコノミックインデックス株式会社')
								]))
						])),
					A2(
					$elm$html$Html$tr,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('2021/4 ~ 2021/6')
								])),
							A2(
							$elm$html$Html$td,
							_List_fromArray(
		...
		body: $author$project$UI$layout(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text($author$project$Pages$Home_$mySelf)
						])),
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					$elm$html$Html$h5,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('学歴')
						])),
					$author$project$Pages$Home_$education,
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					$elm$html$Html$h5,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('職歴')
						])),
					$author$project$Pages$Home_$jobExperiences,
					A2($elm$html$Html$br, _List_Nil, _List_Nil),
					A2(
					$elm$html$Html$p,
					_List_Nil,
...
var $author$project$Pages$Contact$view = {
	body: $author$project$UI$layout(
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Email : tsuyama.s.aa@gmail.com'),
								A2($elm$html$Html$br, _List_Nil, _List_Nil)
							]))
					]))
			])),
...
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Counter':
			return $author$project$Gen$Pages$pages.counter.init(_Utils_Tuple0);
		case 'Home_':
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Counter':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.counter.subscriptions, params, model);
		case 'Home_':
			var params = model_.a;
			var model = model_.b;
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Counter':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.counter.view, params, model);
		case 'Home_':
			var params = model_.a;
			var model = model_.b;
